...
const Footer = () => {
  ...
  return (
    <div id='contact' className='w-full flex flex-col justify-center items-center'>
      {/* 1st box starts here */}
      <div data-aos="zoom-in" data-aos-delay="100" className='w-full bg-themepurple flex flex-wrap justify-center items-center gap-10 py-10'>
      ...
      <div className='w-full lg:px-20 px-5 py-[60px] bg-gray-100 grid lg:grid-cols-[auto,auto,auto,auto,auto] grid-cols-1 justify-between items-start lg:gap-3 gap-10'>
        ...
        <div data-aos="zoom-in" data-aos-delay="200" className='flex flex-col justify-center items-start gap-10 grow'>
          <div className='flex flex-col justify-center items-start gap-4'>
            ...
            <p className='text-gray-500 text-justify'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptas nobis,<br /> ratione laboriosam tempore delectus fuga excepturi placeat <br /> autem omnis nihil! Voluptatibus ea cum  aut omnis sit iste perspiciatis porro autem.</p>
          </div>
          <div className='flex flex-col justify-center items-start gap-4'>
        ...
        <div data-aos="zoom-in" data-aos-delay="200">
          ...
          <ul className='mt-8 flex flex-col justify-center items-start gap-2'>
            <li className='text-gray-500 cursor-pointer hover:text-black'>Wireless headphone</li>
      ...
      <div className='w-full lg:px-20 px-5 py-[40px] bg-gray-100'>
        ...
        <div className='w-full flex lg:flex-row flex-col justify-between items-center lg:gap-4 gap-10'>
          ...
          <div className='lg:w-[20%] w-full'>
            <p className='text-gray-500 lg:text-end text-center'>2026 Powered by Debug Entity</p>
          </div>
        </div>
      </div>
      {/* 3rd box ends here */}
