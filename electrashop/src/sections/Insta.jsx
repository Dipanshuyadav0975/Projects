...
const Insta = () => {
 ...
 useEffect(() => {
  ...
  return (
    <div className='w-full lf:px-20 px-5 py-[80px] bg-white flex flex-col justify-center items-center gap-4'>
      <h1 data-aos="zoom-in" data-aos-delay="100" className='text-themepurple text-xl font-semibold capitailze'>Our Instagram Shop</h1>

      <h1 data-aos="zoom-in" data-aos-delay="200" className='text-black font-semibold text-[42px] leading-[50px] capitailze'>Follow on Instagram</h1>
